...
, [foursquare_id] nvarchar(2147483647) NULL
);
...
, [token] nvarchar(2147483647) NULL
);

--Telegram entities
CREATE TABLE [telegram_users] (
  [id] bigint NULL
, [first_name] nvarchar(2147483647) NULL
, [last_name] nvarchar(2147483647) NULL
, [username] nvarchar(2147483647) NULL
);
...
, [issended] bit DEFAULT true NOT NULL
);
...
, [is_dialog_opened] bit DEFAULT true NOT NULL
);
